...
<?php if ($comments) : ?>
	<h3 id="comments"><?php comments_number('Nobody has yet responded', 'One person has responded', '% people have responded' );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ('open' == $post->comment_status) : ?>
	 ...
	 <?php else : // comments are closed ?>
		...
		<p class="nocomments">Sorry, responses are closed.</p>
...
<h3 id="respond">Leave your response to this post here!</h3>
...
<label for="email"><small>Email (we won't share this!)</small></label></p>
...
<p align="left"><input name="submit" type="submit" id="submit" tabindex="5" value="Submit Response" /></p>
